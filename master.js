	...
	if (command.split(' ')[1] == 'BIO'){
		output.innerHTML = `<p class="BIO">
		       ...
		       <span style='font-weight: bold; color: #ffffff; font-size: 13px;'> */ I’m a Full-Stack Developer located in Kenya. I have a serious passion for UI effects, 
                       ...
                       <br> Fan of NBA, outdoor activities, Video Games and English literature. <br> A family person, a brother.</span>
			...
			output.innerHTML = `<div class='certificates'>
						  ...
						  <h3>/Github</h3>
                                                <a href="#" target='_blank'><img src="./svg icons/github.svg" style="height:30px;width:30px;"></a>
                                              </div>
                                            </div>
					        ...
					        <div class='certificate'>
						  <h3>/LinkedIn</h3>
                                                <a href="#" target='_blank'><img src="./svg icons/linkedin.svg" style="height:30px;width:30px;"></a>
                                              </div>
                                            </div>
					        ...
					        <div class='certificate'>
						  <h3>/DevCon</h3>
                                                <a href="#" target='_blank'><img src="./svg icons/command.svg" style="height:30px;width:30px;"></a>
                                              </div>
                                            </div>
					        ...
					        <div class='certificate'>
						  <h3>/CodePro</h3>
                                                <a href="#" target='_blank'><img src="./svg icons/terminal.svg" style="height:30px;width:30px;"></a>
                                              </div>
                                            </div>
                                           </div>
                                         ${commandBox}`
				...
				<div class='certificates'>
						...
						<h3>/icreative</h3>
                                           ...
                                           <div class='cert'>
                                             <div class='certificate'>
					       <h3>/Grou.py</h3>
                                               <a href="C:/Users/Admin/Downloads/ICREATIVE CO/mix.mp4" target='_blank'>view</a>
					     </div>
                                           </div> 
					    ...
					    <div class='certificate'>
						<h3>/Umati</h3>
                                                <a href="C:/Users/Admin/Downloads/ICREATIVE CO/projektX/UMATI.html">view</a>
                                             </div>
                                          </div>
